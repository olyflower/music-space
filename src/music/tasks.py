...
def generate_genres():
    genres_data = [
        {"name": "Rock", "description": "Rock music is a broad genre of popular music that originated "
        ...
        {"name": "Pop", "description": "Pop is a genre of popular music that originated in its modern form "
        ...
        {"name": "Hip Hop", "description": "Hip-hop and Rap music are mainly described as stylized rhythmic "
                                           ...
                                           "and graffiti. "},
        {"name": "Jazz", "description": "Jazz is a music genre that originated in the African-American communities "
                                        "of New Orleans, Louisiana, United States, in the late 19th and "
                                        "early 20th centuries, with its roots in blues and ragtime."},
        {"name": "Blues", "description": "A genre and musical form developed by African Americans in the "
                                         ...
                                         "groove effect."},
        {"name": "Country", "description": "Also known as country and western, country music has its roots in "
        ...
        {"name": "Folk", "description": "A genre that evolved from traditional music during the 20th century folk "
                                        ...
                                        "of time."},
        {"name": "Reggae", "description": "Reggae music originated from Jamaica during the late 1960s. "
        ...
        {"name": "R&B", "description": "A genre of popular African-American music that originated in the 1940s as "
        ...
        {"name": "Soul", "description": "A popular music genre that combines elements of African-American gospel "
                                        "music, rhythm and blues and jazz."},
        {"name": "Funk", "description": "Funk is a music genre that originated in African American communities "
