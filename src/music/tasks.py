...
def generate_genres(count):
    genres_lst = ["Rock", "Pop", "Hip Hop", "Jazz", "Blues", "Country", "Folk", "Reggae", "R&B", "Soul", "Funk"]
    faker = Faker()
    for _ in range(count):
        Genre.objects.create(name=random.choice(genres_lst), description=faker.sentences(nb=3))
